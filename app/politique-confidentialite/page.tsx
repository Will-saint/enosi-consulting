      ...
      <main className="pt-28 pb-24 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-14">
            ...
            <p className="text-[rgba(30,30,30,0.5)] text-sm leading-relaxed max-w-xl">
          ...
          <div className="space-y-12">
            ...
            <section className="pb-10 border-b border-[rgba(0,0,0,0.08)]">
              ...
              <div className="space-y-2 text-sm text-[rgba(30,30,30,0.55)] leading-relaxed">
                <p><span className="text-[#3a3a3a] font-medium">Entité :</span> Enosi Consulting</p>
                <p><span className="text-[#3a3a3a] font-medium">Responsable :</span> William Saint-Dizier</p>
                <p>
            ...
            <section className="pb-10 border-b border-[rgba(0,0,0,0.08)]">
              ...
              <p className="text-sm text-[rgba(30,30,30,0.55)] leading-relaxed mb-4">
              ...
              <ul className="space-y-2">
                {["Nom et prénom", "Adresse email", "Message libre décrivant votre besoin"].map((item) => (
                  <li key={item} className="flex gap-3 items-start text-sm text-[rgba(30,30,30,0.55)]">
                    <span className="text-[#1a9e5c] shrink-0 mt-0.5">—</span>
                    {item}
                  </li>
                ))}
              </ul>
              <p className="text-sm text-[rgba(30,30,30,0.5)] mt-4 leading-relaxed">
            ...
            <section className="pb-10 border-b border-[rgba(0,0,0,0.08)]">
              ...
              <div className="space-y-4">
                <div className="rounded-lg border border-[rgba(0,0,0,0.08)] p-4">
                  <p className="text-sm text-[#3a3a3a] font-medium mb-1">Resend (resend.com)</p>
                  <p className="text-sm text-[rgba(30,30,30,0.5)] leading-relaxed">Service d&apos;envoi d&apos;emails transactionnels — traite les données du formulaire de contact (nom, email, message) pour acheminer votre message. Données hébergées aux États-Unis, transfert encadré par des clauses contractuelles types (CCT). Politique de confidentialité : <span className="text-[rgba(30,30,30,0.55)]">resend.com/privacy</span></p>
                </div>
                <div className="rounded-lg border border-[rgba(0,0,0,0.08)] p-4">
                  <p className="text-sm text-[#3a3a3a] font-medium mb-1">Vercel Inc. (vercel.com)</p>
                  <p className="text-sm text-[rgba(30,30,30,0.5)] leading-relaxed">Hébergeur du site — traite les données de navigation (logs serveur) de façon transitoire. Données hébergées aux États-Unis, transfert encadré par des CCT.</p>
                </div>
                <div className="rounded-lg border border-[rgba(0,0,0,0.08)] p-4">
                  <p className="text-sm text-[#3a3a3a] font-medium mb-1">Plausible Analytics (plausible.io)</p>
                  <p className="text-sm text-[rgba(30,30,30,0.5)] leading-relaxed">Outil de mesure d&apos;audience privacy-first — ne dépose aucun cookie, ne collecte aucune donnée personnelle identifiable, ne permet aucun suivi individuel. Données agrégées hébergées dans l&apos;UE. Aucun consentement préalable requis au titre de la CNIL.</p>
                </div>
              </div>
            </section>
            ...
            <section className="pb-10 border-b border-[rgba(0,0,0,0.08)]">
              ...
              <p className="text-sm text-[rgba(30,30,30,0.55)] leading-relaxed">
                Les données sont conservées pendant une durée maximale de <span className="text-[#3a3a3a] font-medium">12 mois</span> à compter de la date de réception du message, puis supprimées.
              </p>
            </section>
