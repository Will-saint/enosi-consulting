          ...
          <div className="space-y-12">
            ...
            <section className="pb-10 border-b border-[#1e1e1e]">
              ...
              <div className="space-y-2 text-sm text-gray-400 leading-relaxed">
                <p><span className="text-gray-300 font-medium">Dénomination sociale :</span> Enosi Consulting</p>
                <p><span className="text-gray-300 font-medium">Responsable de la publication :</span> William Saint-Dizier</p>
                <p><span className="text-gray-300 font-medium">Adresse :</span> [Adresse à compléter]</p>
                <p><span className="text-gray-300 font-medium">SIRET :</span> [SIRET à compléter]</p>
                <p>
            ...
            <section className="pb-10 border-b border-[#1e1e1e]">
              ...
              <div className="space-y-2 text-sm text-gray-400 leading-relaxed">
                <p><span className="text-gray-300 font-medium">Hébergeur :</span> Vercel Inc.</p>
                <p><span className="text-gray-300 font-medium">Adresse :</span> 340 Pine Street, Suite 1002, San Francisco, CA 94104, États-Unis</p>
                <p><span className="text-gray-300 font-medium">Site :</span> vercel.com</p>
              </div>
            </section>
